...
$(function () {
    ...
    $(".combobox").on("click", function () {
        if (
            !$(this).find(".combobox__item").hasClass("combobox__item_visible")
        ) {
            $(this).css({
            ...
            if (
                $(this)
                    .parents(".combobox")
                    .find(".combobox__list")
                    .hasClass("combobox__list_invisible")
            ) {
            ...
            $(this)
                .find(".combobox__list")
                .removeClass("combobox__list_invisible");
            ...
            $(this)
                .find(".combobox__item")
                .removeClass("combobox__item_visible");
            $(this)
                .find(".combobox__list")
                .addClass("combobox__list_invisible");
            $(this).find(".combobox-header__icon").css({
    ...
    $(".combobox").on("click", ".combobox__list .combobox__item", function () {
        ...
        $(this)
            .parents(".combobox")
            .find(".combobox-header__subtitle")
            .text($(this).text());
        $(this)
            .parents(".combobox")
            .find(".combobox-header__subtitle")
        ...
        $(this)
            .parents(".combobox")
            .find(".combobox-header__subtitle")
            .removeClass("combobox-header__subtitle_invisible");
        ...
        if ($(this).parents(".combobox").hasClass("search-tour__from")) {
            let id = $(this)
                .parents(".search-tour__from.combobox")
                .find(".combobox-header__subtitle")
                .data("id");
            from = $(this)
                .parents(".search-tour__from.combobox")
        ...
        if (
            $(this).parents(".combobox").hasClass("search-tour__people-count")
        ) {
            adults = $(this)
                .parents(".combobox")
                .find(".combobox-header__subtitle")
    ...
    $(document).on("mouseup", function (e) {
        if (
            combobox != undefined &&
            !$(combobox).is(e.target) &&
            $(combobox).parents(".combobox").has(e.target).length === 0
        ) {
    ...
    $('input[name="datefilter"]').on(
        ...
        function (ev, picker) {
            $(this)
                .parents("label")
                .find(".search-tour-dates__subtitle")
                .text(
            ...
            $(".search-tour-nights__subtitle").removeClass(
                "search-tour-nights__subtitle_invisible"
            );
    ...
    $('input[name="tour_datefilter"]').on(
        "hide.daterangepicker",
        function (ev, picker) {
            $(".tour-cost-dates__subtitle").text(
    ...
    $("#feedback-data").on("hide.daterangepicker", function (ev, picker) {
        ...
        range = `${picker.startDate.format("DD.MM")} - ${picker.endDate.format(
            "DD.MM"
        )}`;
    });

    $("#datapicker-from").on("hide.daterangepicker", function (ev, picker) {
        $(".search-tour-dates__subtitle").text(
            `${picker.startDate.format("DD.MM")}`
        );
    ...
    $(".tour-day-programm__text-description").on("click", function () {
        ...
        if ($(block).css("display") == "none") {
            ...
            $(this)
                .parent()
                .find(".tour-day-programm__text-description svg")
                .css({
                    transform: "rotate(180deg)",
                });
        } else {
    ...
    if ($(".subSliders").length > 0)
        subSlider = new Splide(".subSliders", {
            pagination: false,
            arrows: false,
            type: "loop",
            breakpoints: {
    ...
    if ($(".popular-tours__slider").length > 0)
    ...
    if ($(".advertisement-slider").length > 0)
    ...
    if ($(".search-tour-buttons__slider").length > 0)
    ...
    if ($(".personal__slider").length > 0)
        new Splide(".personal__slider", {
            gap: 35,
            pagination: false,
            perPage: 3,
            autoHeight: true,
    ...
    if ($(".tour-gallary__slider").length > 0)
        new Splide(".tour-gallary__slider", {
            gap: 35,
            pagination: false,
            perPage: 3,
            autoHeight: true,
    ...
    if ($(".tour-day-programm__gallary-slider1").length > 0)
        new Splide(".tour-day-programm__gallary-slider1", {
            gap: 35,
            pagination: false,
            perPage: 4,
            arrows: false,
    ...
    if ($(".tour-day-programm__gallary-slider2").length > 0)
        new Splide(".tour-day-programm__gallary-slider2", {
            gap: 35,
            pagination: false,
            perPage: 4,
            arrows: false,
    ...
    if ($(".tour-day-programm__gallary-slider3").length > 0)
        new Splide(".tour-day-programm__gallary-slider3", {
            gap: 35,
            pagination: false,
            perPage: 4,
            arrows: false,
    ...
    if ($(".tour-day-programm__gallary-slider4").length > 0)
        new Splide(".tour-day-programm__gallary-slider4", {
            gap: 35,
            pagination: false,
            perPage: 4,
            arrows: false,
    ...
    $(".search-tour__hotel-category-category .combobox__item").on(
        "click",
        function () {
            hotelCategory = $(this).data("id");
            $(".search-tour__hotel .combobox-header__subtitle").text(
                $(
                    `.search-tour__hotel .combobox__item[data-star="${hotelCategory}"]`
                )
                    .text()
                    .replace(/\s{2,}/g, "")
            );
            $(".search-tour__hotel .combobox-header__subtitle").removeClass(
                "combobox-header__subtitle_invisible"
            );
    ...
    $(".search-tour__hotel .combobox__item").on("click", function () {
        hotel = $(this).data("id");
        $(".search-tour__hotel-category .combobox-header__subtitle").text(
            $(
                `.search-tour__hotel-category .combobox__item[data-id="${$(
                    this
                ).data("star")}"]`
            ).text()
        );
        $(
            ".search-tour__hotel-category .combobox-header__subtitle"
        ).removeClass("combobox-header__subtitle_invisible");
    ...
    $(".tour-cost__update").on("click", function (e) {
        ...
        if (from == undefined)
            from = $(".search-tour__from .combobox-header__subtitle").data(
                "id"
            );

        if (begDate == undefined)
            $(".tour-cost__date").css("border-right-color", "red");
        if (adults == undefined)
            $(".search-tour__tourist").css("border-right-color", "red");
        if (child == undefined)
            $(".search-tour__children").css("border-right-color", "red");
        if (nights == undefined)
            $(".search-tour__nights").css("border-right-color", "red");
    ...
    $(".tour-cost__button").on("click", function (e) {
        ...
        if (
            ...
            if ($(".tour-cost__value").text() == "Тур не найден")
                ...
                window.open(
                    `https://samo.mercury-europe.ru/bron_person?CATCLAIM=${id}&CURRENCY=1&TOWNFROMINC=${from}&STATEINC=${country}&GUEST=1`
                );
        }
    });
    ...
    $(".tour-download").on("click", function () {
        window.open(
            `${location.origin}/files?url=${location.pathname.replace(
                /\/\w+\//,
                ""
            )}`
        );
    ...
    $(".modal-aggrees__description input[type='checkbox']").on(
        "change",
        function () {
    ...
    $(".registration__register-button").on("click", function (e) {
        ...
        if (
            ...
            password.val() == ""
                ? password.css("border-right-color", "red")
                : null;
    ...
    $(".reset-password-send-mail").on("submit", function (e) {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function (response) {
                $("#notification-small .modal-notification__text").text(
                    response.message
                );
                $(this).parents(".modal-wrapper").hide();
    ...
    $(".reset-password").on("submit", function (e) {
        ...
        $.ajax({
            ...
            data: {
                ...
                retypePassword: $(this)
                    .find("input[name='retype-password']")
                    .val(),
                token: token,
            },
            dataType: "json",
    ...
    $(".services-country-tour__all-button").on("click", function () {
        if (
            $(this)
                .html()
                .match(/Просмотреть\sвсе\s+страны/)
        ) {
            $(this).html(
                $(this)
                    .html()
                    .replace(/Просмотреть\sвсе\s+страны/, "Скрыть")
            );
            $(this).find("svg").css("transform", "rotate(-90deg)");
            $(this)
                .parents(".services-country-tour")
                .find(".service_country__sublist")
                .css("overflow-y", "scroll");
            $(this)
                .parents(".services-country-tour")
                .find(".service_country__sublist")
                .animate({ "max-height": "250px" }, 1000);
        } else {
            $(this).html(
                $(this)
                    .html()
                    .replace(/Скрыть/, "Просмотреть все страны")
            );
            $(this).find("svg").css("transform", "rotate(90deg)");
            $(this)
                .parents(".services-country-tour")
    ...
    $(".services-type-tour__all-button").on("click", function () {
        if (
            $(this)
                .html()
                .match(/Просмотреть\sвсе\s+типы/)
        ) {
            $(this).html(
                $(this)
                    .html()
                    .replace(/Просмотреть\sвсе\s+типы/, "Скрыть")
            );
            $(this).find("svg").css("transform", "rotate(-90deg)");
            $(this)
                .parents(".services-vacation-type")
                .find(".services-vacation-type__list")
                .css("overflow-y", "scroll");
            $(this)
                .parents(".services-vacation-type")
                .find(".services-vacation-type__list")
            ...
            $(this).html(
                $(this)
                    .html()
                    .replace(/Скрыть/, "Просмотреть все типы")
            );
            $(this).find("svg").css("transform", "rotate(90deg)");
            $(this)
                .parents(".services-vacation-type")
    ...
    $(".mailling").on("submit", function (e) {
        ...
        if (
            !$("#law-aggree2").prop("checked") ||
            agent.find(".combobox-header__subtitle").text() == "Кто вы?"
        ) {
            !$("#law-aggree2").prop("checked")
                ? $(".modal-aggrees__checkbox").css("border-color", "red")
                : null;
            agent.find(".combobox-header__subtitle").text() == "Кто вы?"
                ? agent.css("border-right-color", "red")
                : null;
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                Array.from(response.countries).forEach((el) => {
                    $(".feedback__to .combobox__list").append(
                        `<span data-id="${el.id_country}" class="combobox__item">${el.country}</span >`
                    );
                });
            },
        });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                Array.from(response.cities).forEach((el) => {
                    $(".feedback__from .combobox__list").append(
                        `<span data-id="${el.id_city}" class="combobox__item">${el.city}</span >`
                    );
                });
            },
        });
    ...
    $(".feedback").on("submit", function (e) {
        ...
        if (
            !$("#law-aggree1").prop("checked") ||
            from.find(".combobox-header__subtitle").text() == "" ||
            to.find(".combobox-header__subtitle").text() == ""
        ) {
            from.find(".combobox-header__subtitle").text() == ""
                ? from.css("border-right-color", "red")
                : null;
            to.find(".combobox-header__subtitle").text() == ""
                ? to.css("border-right-color", "red")
                : null;
    ...
    $(".search-tour__to").on("click", ".combobox__item", function () {
        $.ajax({
            ...
            success: function (response) {
                ...
                Array.from(response.cities).forEach((el) => {
                    $(".search-tour__from .combobox__list").append(
                        `<span data-id="${el.id_city}" class="combobox__item">${el.city}</span >`
                    );
                });
            },
    ...
    $(".search-tour__from").on("click", ".combobox__item", function () {
        $.ajax({
            ...
            success: function (response) {
                ...
                Array.from(response.countries).forEach((el) => {
                    $(".search-tour__to .combobox__list").append(
                        `<span data-id="${el.id_country}" class="combobox__item">${el.country}</span >`
                    );
                });
            },
