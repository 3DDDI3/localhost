<div class="tour-day-programm__item">
    <div class="tour-day-programm__text-description">
        <div class="tour-day-programm__text-block">
            <span class="tour-day-programm__day">{{ $attributes->get('title') }}</span>
            <span class="tour-day-programm__title">{{ $attributes->get('subtitle') }}</span>
        </div>
    ...
    <div class="tour-day-programm__description" style="display: none;">
