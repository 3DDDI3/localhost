    ...
    <div class="news">
        <div class="news__headding page-headding">
            ...
            <button class="news__all-news"
                data-href="{{ \Illuminate\Support\Str::lower($attributes->get('title')) == 'новости' || \Illuminate\Support\Str::lower($attributes->get('subtitle')) == 'новости' ? '/news' : '/blogs' }}">
                <span>
                    {{ \Illuminate\Support\Str::lower($attributes->get('title')) == 'новости' || \Illuminate\Support\Str::lower($attributes->get('subtitle')) == 'новости' ? 'Все новости' : 'Все блоги' }}
