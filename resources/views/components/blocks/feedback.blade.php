<form class="modal__form feedback">
    <div class="modal-form__fields feedback__fields">
        <div class="feedback__columns">
            <input type="text" name="name" class="feedback__text modal-form__text input__text" placeholder="Имя">
            <input type="text" name="phone" class="feedback__text modal-form__text input__text" placeholder="Телефон">
            <input type="email" name="login" class="feedback__text modal-form__text input__email"
                placeholder="Email">
        </div>
