...
@section('content')
                    ...
                    <li class="splide__slide">
                        <div class="slider__block">
                            <div class="slider-text-wrapper">
                                <span class="slider__title">удивительный</span>
                                <span class="slider__text">Пхукет</span>
                            </div>
                        ...
                        <ul class="splide__list">
                            <li class="splide__slide">
                                <x-templates.tour type="хит" alt="" img="{{ asset('images/card1.png') }}"
                                    ...
                                    nights="7-12 ночей" price="от 120 587 ₽" url="" />
                            </li>
                            <li class="splide__slide">
                                <x-templates.tour type="хит" alt="" img="{{ asset('images/card1.png') }}"
                                    info="Касабланка - Рабат - Шефшауэн - (Волюбилис) - Фес - Мерзуга - Уарзазат - Айт бен Хадду"
    ...
    {{-- <x-templates.news img="{{ asset('images/card1.png') }}" alt=" " date="15.04.2024"
        title="Авиакомпания Utair повезет туристов в Анталью и Сочи" />
    <x-templates.tour type="Хит"
        info="Касабланка - Рабат - Шефшауэн -
            (Волюбилис) - Фес - Мерзуга - Уарзазат - Айт бен Хадду"
        title="Майские праздники в Тайланде"
        text="Таиланд- это сказочный «остров богов», «остров тысячи храмов» и драгоценная жемчужина Индонезии... В цене проживани..."
        nights="7-12 ночей" price="от 120 587 ₽" url=" " />
    <x-templates.blog img="{{ asset('images/blog/1.png') }}" alt="" url="" date="15.04.2024"
    ...
    @include('includes.sections.section_7')
     --}}

    {{-- @include('includes.blocks.form') --}}
@endsection
