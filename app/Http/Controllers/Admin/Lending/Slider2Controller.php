...
{
    public $PATH = 'lending.slider2';
    public $TITLE = ['Слайдер 2', 'элемента слайдера'];
    public $MODEL = Slider2::class;
    ...
    public function edit(Request $request, $id = null)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $object->save();
            FileUpload::uploadImage('image', $this->MODEL, 'image', $object->id, 377, 377, '/images/slider2', false, $request);
